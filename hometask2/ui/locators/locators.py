...
class BaseActionsLocators:
    ...
    LOGOUT_BUTTON = (By.XPATH, '//ul[@class="rightMenu-module-rightMenu-2GKiG5 rightMenu-module-shownRightMenu-2p7e0v rightMenu-module-visibleRightMenu-2Sl9o8"]//li[2]')
...
class LoginPageLocators:
    ...
    INCORRECT_EMAIL_OR_TEL_NUMBER__ELEMENT = (By.XPATH, '//div[@class="notify-module-error-drhIFC notify-module-notifyBlock-G7o6Wi"]')
...
class CampaignsListPageLocators:
    ...
    CAMPAIGN_NAME_FIELD = (By.XPATH, '//div[@class="input input_campaign-name input_with-close"]//input[@class="input__inp js-form-element"]')
    ...
    CHECKBOX_FOR_ALL_CAMPAIGNS = (By.XPATH, '//input[@class="flexi-table-nt__header__checkbox js-flexi-table_header_checkbox"]')
    ACTIONS_BUTTON = (By.XPATH, '//div[@class="button__text" and contains(text(), "Действия")]')
    DELETE_BUTTON = (By.XPATH, '//span[@class="drop-down-item-view__name js-item-name" and contains(text(), "Удалить")]')
...
class SegmentsPageLocators:
    ...
    ADD_AUDIENCE_SEGMENTS_BUTTON = (By.XPATH, '//div[@class="create-segment-form__block create-segment-form__block_add js-add-segments-button"]')
    CHECKBOX1_1 = (By.XPATH, '//div[@class="adding-segments-source__header  adding-segments-source__header_with-icon js-source-header-wrap"]')
    CHECKBOX1_2 = (By.XPATH, '//div[@class="payer-settings-view__settings-name-wrap"]//span[@data-translated="Paid on the platform"]')
    CHECKBOX2_1 = (By.XPATH, '//input[@class="adding-segments-source__checkbox js-main-source-checkbox"]')
    SUBMIT_CONFIGURE_SEGMENT_BUTTON = (By.XPATH, '//button[@data-class-name="Submit"]//div[@class="button__text" and contains(text(), "Добавить сегмент")]')
    SEGMENT_NAME_FIELD = (By.XPATH, '//div[@class="input input_create-segment-form"]//input[@class="input__inp js-form-element"]')
    SUBMIT_CREATE_SEGMENT_BUTTON = (By.XPATH, '//div[@class="create-segment-form__btn-wrap js-create-segment-button-wrap"]//div[@class="button__text"]')
